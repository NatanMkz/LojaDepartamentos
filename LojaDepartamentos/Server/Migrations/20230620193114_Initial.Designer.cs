...
namespace LojaDepartamentos.Server.Migrations
{
    ...
    [Migration("20230620193114_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.Carrinho", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.CarrinhoItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.Categoria", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.Produto", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.Usuario", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.CarrinhoItem", b =>
                {
                    b.HasOne("LojaDepartamentos.Shared.Entities.Carrinho", "Carrinho")
                        .WithMany("Itens")
                        .HasForeignKey("CarrinhoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("LojaDepartamentos.Shared.Entities.Produto", "Produto")
                        .WithMany("Itens")
            ...
            modelBuilder.Entity("LojaDepartamentos.Shared.Entities.Produto", b =>
                {
                    b.HasOne("LojaDepartamentos.Shared.Entities.Categoria", "Categoria")
                        .WithMany("Produtos")
